...
@Table(name = "items", indexes = {
        @Index(name = "idx_item_name",   columnList = "name",   unique = true),
...
public class Item {
    ...
    /* Unique item code, auto-generated server-side (e.g. ITM000123) */
    ...
    /* ── ToT ── */
    @Convert(converter = ToTStatusConverter.class)
    ...
    /* Which ToT document types were filed, e.g. ["TTD","TNF","TAC","CEC"] */
    @ElementCollection(fetch = FetchType.EAGER)
    @CollectionTable(name = "item_tot_documents",
    ...
    public enum ToTStatus {
        ...
        public static ToTStatus fromString(String value) {
            if (value == null) return null;
            return switch (value.trim()) {
                case "Filed", "Filled", "Filed (TnF)", "Filed (TAC)",
                     "Filled (TnF)", "Filled (TAC)" -> FILED;
                case "To Be Filed", "To Be Filled"   -> TO_BE_FILED;
                default -> {
