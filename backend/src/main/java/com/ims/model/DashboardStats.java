...
public class DashboardStats implements Serializable {
    ...
    // Per-type IPR counts (from IPRDetail table)
    private long patentFiledCount;
    private long patentGrantedCount;
    private long trademarkFiledCount;
    ...
    public static class UpcomingDueDateItem implements Serializable {
        ...
        /* "dev" = Product Development Completion, "tot" = ToT Validity renewal */
        private String type;
    }
