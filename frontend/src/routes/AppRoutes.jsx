...
const EditVariantForm = lazy(() => import("../pages/Items/EditVariantForm"));
      ...
      <Suspense fallback={<Loader variant="page" text="Loading..." />}>
        <Routes>
          ...
          <Route element={<RequireAuth><MainLayout /></RequireAuth>}>
            ...
            <Route path="/items/:id/variants/:variantId/edit" element={<EditVariantForm />} />
            <Route path="/notifications"  element={<Notifications />} />
            {/* Unknown protected paths get a real 404 instead of a silent redirect */}
